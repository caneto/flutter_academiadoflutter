...
<table> 
  ...
  <tr>
   ...
   <tr>
    ...
    <td><b>Home</b> (Construindo AppBar da HomePage, Implementando componente de apresentação do endereço, Criando componente de categorias, Construindo busca das categorias no backend, Conectando tela com serviço (categorias), Criando componentes de Tab (Lista e Grid)) </td>
    <td></td>
  </tr>
</table>   
