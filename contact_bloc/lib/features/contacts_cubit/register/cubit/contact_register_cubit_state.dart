...
class ContactRegisterCubitState with _$ContactRegisterCubitState{
  ...
  const factory ContactRegisterCubitState.data({required List<ContactModel> contacts}) =
      _Data;
  const factory ContactRegisterCubitState.error({required String error}) = _Error;
